...
![Illustration of a researcher in a library interacting with glowing digital screens displaying charts, code, and documents](/images/use-ai-head.png)
...
![Screenshot of a post by Ethan Mollick on X emphasizing the importance of testing AI on your own use cases rather than relying on others' experiences](/images/mollick-tweet.png)
...
![Network diagram with a central node connected to many smaller nodes, representing how AI deep research connects related sources across a body of literature](/images/network.webp)
...
![AI-generated four-panel comic in Schoolhouse Rock style showing how a bill becomes a regulation: a bill is passed by Congress, the law is given to an agency, regulations are created, and the program is implemented](/images/just-a-rule.png)
...
![Screenshot of ChatGPT output describing parameters for simulating regression discontinuity data, including a running variable, quadratic relationship, and treatment cutoff](/images/data-sim.png)
...
![Laptop displaying the Understanding American Politics online textbook on Substack](/images/uap-mockup.png)
