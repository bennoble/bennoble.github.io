...
<!-- A talk should not be a public reading of the paper.

 Yet that is the way work is presented in some disciplines. Who am I to say they are wrong? But it does seem strange to me. After all, publicly reading your paper is inefficient. Reading is much faster than listening, it's also much easier to retain the information. And you can skip the boring parts. If that is the norm in your discipline, maybe don't listen to me. But if it is not the norm, then don't do it. In fact, don't think about your talk as a concentrated version of your research at all. Think of the talk as an advertisement. -->
...
<!-- 
A talk, like an introduction to a paper, should catch people's attention. It should convince them to keep going. It should convince them to invest future time and effort into the work. It should be like a test drive at the used car lot. The salesperson does not read you the owner's manual. Let people kick the tires, drive around the block, ask a few questions.

Your goal is not to communicate the full contents of your paper such that the audience has a perfect understanding of everything you've done. Rather, your goal is to share the idea, to tease the important theoretical contribution, the interesting data and methods, the broad idea—such that those in the audience feel compelled to go read the paper after you finish. 

A talk is not a substitute for the paper. It simply cannot be given the time and attention constraints.  -->

<!-- Attending a talk is not a substitute for reading a paper. Rather, a talk is an advertisement for a paper and the person who wrote that paper. Some subset of people might read the paper with or without the talk, but many people may not know about the paper in the absence of the talk.  -->
<!-- Many different types of people are attending your talk—folks in your sub-field with a deep and abiding interest and knowledge of the topic, yes, but also people in different subfields of the discipline, possibly even different disciplines.  -->
...
<!-- But presentations are also a time when you open yourself up to very visible and immediate scrutiny. It's one thing for anonymous reviewer 2 to provide written feedback over email, it's another for senior professor 3 to do so in your face in real time. But that is why invest your time in preparation and practice (and why you don't put your slides together while the other panelists are presenting). -->
<!-- Of course, when you present, you are also opening yourself up to questions and criticisms. You cannot control how others will react or what questions they might ask, but you can control the quality of the underlying research and of the presentation itself. Presenting is sales, and the more confidence you have in what you're selling, the easier it is. -->
